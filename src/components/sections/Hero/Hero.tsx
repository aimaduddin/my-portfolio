        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
              <span className="block text-gray-900">Hi, I'm John Doe</span>
              <span className="block text-blue-600 mt-2">Full Stack Developer</span>
            </h1>
            
            <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed">
              I craft responsive websites where technology meets creativity. Building 
              innovative solutions and bringing ideas to life in the digital world.
            </p>
          ...
          <div className="relative h-[600px] w-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-100/40 to-purple-100/40 rounded-[30px] 
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8">
                <div className="relative w-full max-w-md aspect-[3/4] group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-[20px] 
                                blur-md opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
                  
                  {/* Image container */}
                  <div className="relative h-full rounded-[18px] overflow-hidden shadow-2xl">
                    <Image
